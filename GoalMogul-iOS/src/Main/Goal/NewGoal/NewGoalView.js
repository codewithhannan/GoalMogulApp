...
class NewGoalView extends Component {
  ...
  onTaggingSuggestionTap(item, hidePanel, cursorPosition) {
    ...
    const containsTag = newTags.some(
      (t) => t.tagReg === `\\B@${name}` && t.startIndex === content.length + 1
    );
  ...
  renderPrivacyControl(isEdit) {
    return (
      <View style={styles.sectionMargin}>
        <Menu
          rendererProps={{ placement: "top", anchorStyle: styles.anchorStyle }}
        ...
        <WalkableView>
          ...
          >
            <Text style={styles.subTitleTextStyle}>
              Description{" "}
              <Text style={DEFAULT_STYLE.smallText_1}>(Optional)</Text>
            </Text>
            <Text style={DEFAULT_STYLE.smallText_2}>
      ...
      >
        ...
        >
          ...
          <Text style={styles.descriptionTextStyle}>
            Use is to set reletive priority of your Goal.
          </Text>
          {slider}
          <View
            style={{ flexDirection: "row", justifyContent: "space-between" }}
    ...
    const icon = (
      ...
      >
        <Image
          resizeMode="contain"
          source={CalenderIcon}
          style={{ ...DEFAULT_STYLE.buttonIcon_1, tintColor: "#DADADA" }}
        />
      </View>
    );
  ...
  render() {
    ...
    return (
      ...
      >
        ...
        <View
          style={[DEFAULT_STYLE.shadow, { height: 8 * DEFAULT_STYLE.uiScale }]}
        />
...
const FieldTitleText = (props) => {
  ...
  return (
    <View style={{ flexDirection: "row", ...style }}>
      {required && (
        <Text
          style={{ ...styles.subTitleTextStyle, color: "red", paddingRight: 0 }}
        >
          *
        </Text>
      )}
  ...
  return (
    ...
    >
      ...
      <MenuOptions customStyles={styles.menuOptionsStyles}>
        <FlatList
          data={options}
          renderItem={({ item }) => <MenuOption value={item} text={item} />}
