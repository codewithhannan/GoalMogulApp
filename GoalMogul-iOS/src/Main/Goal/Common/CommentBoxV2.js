...
class CommentBoxV2 extends Component {
  ...
  onTaggingSuggestionTap(item, hidePanel, cursorPosition) {
    ...
    console.log(
      `${DEBUG_KEY}: [ onTaggingSuggestionTap ]: prevCursorContent is: `,
      prevCursorContent
    );
    console.log(
      `${DEBUG_KEY}: [ onTaggingSuggestionTap ]: prevCursorContent length is: `,
      prevCursorContent.length
    );
    console.log(
      `${DEBUG_KEY}: [ onTaggingSuggestionTap ]: postCursorContent is: `,
      postCursorContent
    );
    console.log(
      `${DEBUG_KEY}: [ onTaggingSuggestionTap ]: comment is: `,
      comment
    );
    console.log(
      `${DEBUG_KEY}: [ onTaggingSuggestionTap ]: newContentText is: `,
      newContentText
    );
    ...
    const containsTag = newTags.some(
      (t) => t.tagReg === `\\B@${name}` && t.startIndex === comment.length + 1
    );
    ...
    return (
      ...
      >
        <MentionsTextInput
          ...
          renderLeftIcons={() =>
            this.renderLeftIcons(newComment, pageId, hasSuggestion, goalId)
          }
