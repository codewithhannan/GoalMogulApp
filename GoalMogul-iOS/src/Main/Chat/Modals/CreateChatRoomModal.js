...
class CreateChatroomModal extends React.Component {
  ...
  initializeForm() {
    ...
    const initialVals = initializeFromState ? { ...chat } : { ...defaulVals };
    ...
    return (
      <View>
        ...
        <CheckBox
          ...
          uncheckedIcon={<MaterialIcons name="done" color="#CCC" size={21} />}
          onPress={() =>
            this.props.change("membersCanAdd", !this.props.membersCanAdd)
          }
        />
      </View>
    );
  ...
  renderMemberItem(item) {
    return (
      <SearchUserCard
        ...
        cardContainerStyles={
          item.item.isSearchResult ? {} : { backgroundColor: "#D8EDFF" }
        }
      />
    );
  }
  ...
  renderListHeader = () => {
    ...
    return (
      <SearchBar
        ...
        platform="default"
        clearIcon={<MaterialIcons name="clear" color="#777" size={21} />}
        containerStyle={{
