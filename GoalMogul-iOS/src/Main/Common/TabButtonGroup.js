      ...
      if (b && b.tutorial) {
        ...
        return (
          <CopilotStep text={tutorialText} order={order} name={name}>
            <WalkableView style={{ flex: 1 }}>{buttonComponent}</WalkableView>
          </CopilotStep>
        );
      }
    ...
    return (
      <View
        style={{
          ...
          padding:
            (padding !== undefined ? padding : 2) * DEFAULT_STYLE.uiScale,
          height:
            (padding !== undefined ? 36 - padding : 34) * DEFAULT_STYLE.uiScale,
          borderRadius:
            this.props.borderRadius === undefined ? 3 : this.props.borderRadius,
