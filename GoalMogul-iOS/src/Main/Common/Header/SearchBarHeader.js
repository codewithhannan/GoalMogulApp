  ...
  renderRightIcons() {
    ...
    if (
      ...
      return (
        <DelayedButton
          onPress={
            handlePageSetting || this.handleFriendsSettingOnClick.bind(this)
          }
    ...
    if (this.props.rightIcon === "menu") {
        ...
        return (
          ...
          >
            <WalkableView>
              ...
              >
                <Image
                  style={{ height: 24, width: 24, tintColor: rightIconColor }}
                  source={IconMenu}
                />
              </TouchableOpacity>
            </WalkableView>
      ...
      return (
        <View style={{ flexDirection: "row" }}>
          ...
          >
            <Image
              style={{ height: 18, width: 18, tintColor: rightIconColor }}
              source={IconSearch}
            />
          </DelayedButton>
          <TouchableOpacity
