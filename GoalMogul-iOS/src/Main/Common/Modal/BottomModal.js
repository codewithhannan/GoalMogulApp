    ...
    render() {
        return (
            <Modal
                ...
                swipeDirection={'down'}
                style={{ marginTop: Constants.statusBarHeight + 15, borderRadius: 15, margin: 0}}
            >
               
                <View style={{ backgroundColor: 'white', width: '100%', position: 'absolute', bottom: 0, borderRadius: 5}}>
                <View style={{ ...styles.modalContainerStyle, backgroundColor: 'transparent', flex: 1 }}>
