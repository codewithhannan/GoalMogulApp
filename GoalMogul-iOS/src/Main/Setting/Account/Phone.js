    ...
    if (!this.props.needAddPhone) {
      ...
      return (
        <View>
          ...
          >
            <Text style={Styles.actionTextStyle}>Verify phone number</Text>
          </TouchableOpacity>
        </View>
      );
    }
    ...
    return (
      <View style={{ flex: 1, backgroundColor: "#ffffff" }}>
        ...
        <View style={Styles.titleSectionStyle}>
          <Text style={Styles.titleTextStyle}>Phone numbers you've added</Text>
        </View>
        {this.renderBody()}
      </View>
    );
...
const mapStateToProps = (state) => {
  ...
  const needAddPhone =
    !phone || (Object.keys(phone).length === 0 && phone.constructor === Object);
