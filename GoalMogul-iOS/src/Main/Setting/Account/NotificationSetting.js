    ...
    return (
      <View style={{ marginTop: 15 }}>
        <CheckBox
          ...
          onPress={() =>
            this.props.change("pushNotiPref", !this.props.pushNotiPref)
          }
        />
        <CheckBox
          ...
          uncheckedIcon={<MaterialIcons name="done" color="#CCC" size={21} />}
          onPress={() =>
            this.props.change("emailNotiPref", !this.props.emailNotiPref)
          }
        />
      </View>
    );
    ...
    return (
      <View style={{ flex: 1, backgroundColor: "white" }}>
        {/* <LoadingModal 
                ...
                /> */}
        <SearchBarHeader backButton rightIcon="empty" title="Notifications" />
