...
class GoalFeedInfoModal extends React.PureComponent {
      ...
      <View style={{ flexDirection: 'row', marginTop: 22 }}>
        <View style={{ flex: 1, flexWrap: 'wrap' }}>
          <View style={{ flexDirection: 'row', marginBottom: 15 }}>
            <View style={styles.bulletStyle}>
              <Text style={{ ...styles.basicTextStyle, fontWeight: '700' }}>1.</Text>
            </View>
            <View>
          ...
          <View style={{ flexDirection: 'row' }}>
            <View style={styles.bulletStyle}>
              <Text style={{ ...styles.basicTextStyle, fontWeight: '700' }}>2.</Text>
            </View>
            <View>
              <Text style={{ ...styles.basicTextStyle, flexWrap: 'wrap' }}>
        ...
        <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center' }}>
          <View style={styles.forwardButtonContainerStyle}>
            <Image source={ForwardIcon} style={{ height: 40, width: 40, tintColor: 'gray' }} />
          </View>
        </View>
      </View>
    );
  ...
  render() {
    return (
      ...
      >
        <View style={{ flex: 1 }}>
          <TouchableWithoutFeedback onPress={this.handleCancelOnPress}>
            <Animated.View
              style={{ ...styles.backgroundContainerStyle, opacity: this.state.opacity }}
            />
          </TouchableWithoutFeedback>
          <View style={styles.mainContentContainerStyle}>
            <View style={{ padding: 15, paddingTop: 20, paddingBottom: 20, zIndex: 1 }}>
