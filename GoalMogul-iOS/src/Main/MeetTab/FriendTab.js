...
class FriendTab extends React.Component {
      ...
      >
        <View style={{ marginRight: 18, width: "56%" }}>
          ...
          <DelayedButton
            ...
            style={BUTTON_STYLE.GM_BLUE_BG_WHITE_BOLD_TEXT.containerStyle}
          >
            <Text style={[DEFAULT_STYLE.titleText_1, { color: "white" }]}>
              Invite your Friends
            </Text>
          </DelayedButton>
        </View>
      ...
      >
        ...
        {requestCount <= 2 ? null : (
          <DelayedButton
            ...
            style={{ backgroundColor: "#F2F2F2", borderRadius: 3, padding: 10 }}
          >
  ...
  renderFriendRequests = () => {
    return (
      <View
        style={{ width: "100%", backgroundColor: "white", marginBottom: 8 }}
      >
        <View
          style={{
            flexDirection: "row",
        ...
        >
          <Text style={[DEFAULT_STYLE.titleText_1]}>Friend Requests</Text>
          <View style={{ flex: 1 }} />
          <DelayedButton
          ...
          >
            <Text
              style={[
                ...
                { color: GM_BLUE, textDecorationLine: "underline" },
              ]}
            >
              All My Friends
            </Text>
  ...
  render() {
    return (
      <View style={styles.containerStyle}>
        <SearchBarHeader backButton={false} setting={false} rightIcon="menu" />
        <FlatList
