...
import { BUTTON_STYLE as buttonStyle, TEXT_STYLE as textStyle, GM_BLUE, GM_FONT_FAMILY, GM_FONT_SIZE } from '../../styles';
            ...
            case "contacts":
                return (
                    <FlatList 
                        ...
                        renderItem={(props) => this.renderUserCard(props, "contacts", this.inviteUser("contacts"))}
...
const testContacts = {
    data: [
        {  name: "Jia Zeng", phoneNumbers: [{ label: "mobile", number: "9194912504" }] },
        {  name: "Jay Patel", phoneNumbers: [{ label: "mobile", number: "9194912504" }] }
    ]
};

const testMatchedContacts = {
    data:  [
        { name: "Jia Zeng", headline: "I am so cool", maybeInvitationType: "", maybeInvitationId: "", profile: {}}
    ]
};
