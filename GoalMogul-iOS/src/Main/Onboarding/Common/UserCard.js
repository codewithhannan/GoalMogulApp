...
class UserCard extends React.Component {
  ...
  renderAddButton(item, callback) {
    ...
    if (maybeInvitationType == "outgoing") {
      return (
        ...
        >
          <Text style={[styles.buttonStyle.textStyle, styles.addedTextStyle]}>
            Added
          </Text>
        </DelayedButton>
      );
    ...
    return (
      ...
      >
        <Text style={[styles.buttonStyle.textStyle, styles.addButtonTextStyle]}>
          Add
        </Text>
      </DelayedButton>
    );
  ...
  renderInviteContactButton(item, callback) {
    return (
      ...
      >
        <Text
          style={[styles.buttonStyle.textStyle, styles.inviteButtonTextStyle]}
        >
          Invite
        </Text>
      </DelayedButton>
  ...
  renderContactInfo(item) {
    ...
    return (
      ...
      >
        ...
        <Text style={{ fontSize: 12, fontFamily: GM_FONT_FAMILY.GOTHAM }}>
          {infoToDisplay}
        </Text>
      </View>
    );
