  ...
  render() {
    return (
      <View style={styles.containerStyle}>
        <OnboardingHeader />
        <View
          style={{ flex: 1, padding: 20, marginTop: 20, alignItems: "center" }}
        >
          <View style={{ flex: 1, alignItems: "center", width: "100%" }}>
            ...
            <View style={{ marginTop: 40 }}>
              ...
              >
                Here you'll forget deeper & more meaningful connections, based
                on goals & dreams that are truly important to you in life!
              </Text>
            </View>
          </View>
          <DelayedButton
