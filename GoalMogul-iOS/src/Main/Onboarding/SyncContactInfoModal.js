...
import { GM_BLUE, GM_FONT_SIZE, GM_FONT_FAMILY, GM_FONT_LINE_HEIGHT, BUTTON_STYLE as buttonStyle } from '../../styles';
...
class SyncContactInfoModal extends React.Component {
    ...
    renderUploading() {
        return (
            <View style={{ zIndex: 1, position: "absolute", top: 0, left: 0, right: 0, bottom: 0, opacity: this.props.loading ? 1 : 0, alignItems: "center", padding: 35 }}>
                <Text style={{ fontSize: GM_FONT_SIZE.FONT_3_5, fontFamily: GM_FONT_FAMILY.GOTHAM_BOLD }}>Uploading Contacts</Text>
    ...
    renderFailureResult() {
        return (
            <View style={{ zIndex: 2, opacity: this.props.loading ? 0 : 1 }}>
                <Text style={{ fontSize: GM_FONT_SIZE.FONT_3_5, fontFamily: GM_FONT_FAMILY.GOTHAM_BOLD, textAlign: "center", marginBottom: 20 }}>
                ...
                >
                    <Text style={buttonStyle.GM_BLUE_BG_WHITE_BOLD_TEXT.textStyle}>Invite</Text>
                </DelayedButton>
