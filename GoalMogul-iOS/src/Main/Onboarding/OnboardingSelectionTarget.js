      ...
      <View style={{ marginTop: 10 }} key="Other TextInput">
        ...
        >
          <TextInput
            ...
            value={extra}
            onChangeText={(val) =>
              this.props.registrationTargetSelection(title, selected, val)
            }
            minHeight={180}
            maxHeight={180}
            multiline
        ...
        >
          ...
          >
            <CheckBox
              ...
              checked={selected}
              checkedIcon={
                <MaterialIcons name="done" color="#1B63DC" size={21} />
              }
              uncheckedIcon={null}
      ...
      <View style={styles.containerStyle}>
        ...
        <View style={{ flex: 1, justifyContent: "center" }}>
          <View style={{ alignItems: "center", marginTop: 35 }}>
            ...
            <Text style={styles.titleTextStyle}>most important to you?</Text>
