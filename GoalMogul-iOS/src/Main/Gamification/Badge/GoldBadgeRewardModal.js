        ...
        return (
            ...
            >
                <View style={{ ...modalContainerStyle, padding: 10, alignItems: 'flex-start', flex: 1 }}>
                    ...
                    <Text style={{ color: 'rgb(51, 51, 51)', fontWeight: '500', fontSize: 22, marginTop: 20, alignSelf: 'center', marginBottom: 5 }}>Gold Badge Rewards</Text>
                    <ScrollView contentContainerStyle={{ padding: 10 }} persistentScrollbar showsVerticalScrollIndicator>
                        <TextInput 
                            editable={false}
                            multiline
                        ...
                        <TextInput 
                            ...
                            value={'INSTRUCTIONS:'}
                        />
                        <Text style={styles.contentTextStyle} editable={false} multiline>
                            After you receive a Gold Badge, follow these instructions to receive your cash prize:{"\n"}{"\n"}
                            Email <Text editable={false} multiline style={styles.emailTextStyle} onPress={this.handleEmailOnPress}>support@goalmogul.com</Text> with subject line "Gold Badge winner" and in the email let us know your
                        </Text>
                        {/* <Text selectable style={styles.contentTextStyle}>Beginning September 1, 2019, be one of the first fifteen (15) users to attain Gold Badge status and GoalMogul Inc. will reward you with a USD $300.00 cash prize!{`\n`}</Text>
                        ...
                        </Text> */}
                        {
                            bulletPointList.map(l => {
                                return (
                                    <TextInput multiline editable={false} style={styles.contentTextStyle}>{`\u2022 ${l}`}</TextInput>
                                )
                            })
                        }
                        <TextInput multiline editable={false} style={styles.contentTextStyle}>{"\n"}After we verify that you are one of the first fifteen (15) Gold Badge users, we will reply to your email to arrange online direct payment of USD$300.00 to you via Paypal or Venmo.</TextInput>
                        <Text selectable style={styles.contentTextStyle}>{"\n"}Please contact <Text onPress={this.handleEmailOnPress} style={styles.emailTextStyle}>support@goalmogul.com</Text> if you have any questions.</Text>
                    </ScrollView>
