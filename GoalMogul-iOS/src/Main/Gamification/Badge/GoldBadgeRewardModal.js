        ...
        >
          ...
          >
            ...
            <Text style={styles.contentTextStyle} editable={false} multiline>
              After you receive a Gold Badge, follow these instructions to
              receive your cash prize:{"\n"}
              {"\n"}
              Email{" "}
              <Text
                editable={false}
              ...
              with subject line "Gold Badge winner" and in the email let us know
              your
            </Text>
            ...
            <TextInput
              ...
              style={styles.contentTextStyle}
            >
              {"\n"}After we verify that you are one of the first fifteen (15)
              Gold Badge users, we will reply to your email to arrange online
              direct payment of USD$300.00 to you via Paypal or Venmo.
            </TextInput>
            <Text selectable style={styles.contentTextStyle}>
              {"\n"}Please contact{" "}
              <Text
