        ...
        return (
            ...
            >
                <View style={modalContainerStyle}>
                    ...
                    <Text style={{ color: 'rgb(51, 51, 51)', fontWeight: '500', fontSize: 22, marginTop: 5 }}>The Gold Badge</Text>
                    {this.renderGoldBadge()}
                    {/* Divider */}
                    <View style={{ width: '76%', height: 0.5, backgroundColor: 'rgb(238, 238, 238)', marginVertical: 14 }} />
                    <Text style={{ fontSize: 15, lineHeight: 18, color: 'rgb(51, 51, 51)' }}>
                        You will be awarded the gold badge when you have invited 10 Silver/Gold badge friends with your personal invite link.
                    </Text>

                    <Text style={{ fontSize: 15, lineHeight: 17, color: 'rgb(51, 51, 51)', marginTop: 10 }}>
                        Get your personal invite link by visiting the friends tab as pressing <Text style={{ fontWeight: '600' }}>"Invite friends now"</Text>
                    </Text>
                    
                    <Image 
                        source={InviteFriendGuideImage}
                        style={{ width: windowWith * 0.76, height: windowWith * 0.76 * 582 / 750, borderRadius: 10, marginTop: 10 }}
                        resizeMode='cover'
                    />
                </View>
            </Modal>
