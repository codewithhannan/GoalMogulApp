    ...
    return (
      ...
      >
        <View style={modalContainerStyle}>
          ...
          />
          <Text
            style={{ fontSize: 15, lineHeight: 18, color: "rgb(51, 51, 51)" }}
          >
            You will be awarded the gold badge when you have invited 10
            Silver/Gold badge friends with your personal invite link.
          </Text>
          ...
          >
            Get your personal invite link by visiting the friends tab as
            pressing{" "}
            <Text style={{ fontWeight: "600" }}>"Invite friends now"</Text>
          </Text>
