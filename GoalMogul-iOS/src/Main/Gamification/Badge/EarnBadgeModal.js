...
class EarnBadgeModal extends React.PureComponent {
  ...
  render() {
    let tier = 0;
    if (
      _.has(this.props.user, "profile.badges.milestoneBadge.currentMilestone")
    ) {
      tier = _.get(
        this.props.user,
        "profile.badges.milestoneBadge.currentMilestone"
    ...
    const hasModalOverlay =
      this.state.showGoldBadgeRewardModal || this.state.showGoldBagdeInfoModal;
      ...
      >
        ...
        <View style={{ backgroundColor: "white", borderRadius: 15 }}>
          <ImageBackground
            ...
            style={{ width: "100%", minHeight: 608, borderRadius: 15 }}
