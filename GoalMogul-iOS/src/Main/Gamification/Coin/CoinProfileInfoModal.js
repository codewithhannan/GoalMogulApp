/**
 * This is the coin related info modal on profile page
...
class CoinProfileInfoModal extends React.PureComponent {
  closeModal() {
      ...
      >
        <View style={{ ...modalContainerStyle, padding: 25 }}>
          ...
          >
            ...
            <Text
              style={{ fontSize: 22, marginLeft: 5, color: "rgb(51, 51, 51)" }}
            >
              Coins
            </Text>
          </View>
...
export default CoinProfileInfoModal;
