...
export const SHARE_TO_CHAT_UPDATE_SELECTED_ITEMS = 'SHARE_TO_CHAT_UPDATE_SELECTED_ITEMS';
export const SHARE_TO_CHAT_UPDATE_SEARCH_QUERY = 'SHARE_TO_CHAT_UPDATE_SEARCH_QUERY';
export const SHARE_TO_CHAT_UPDATE_SHARE_MESSAGE = 'SHARE_TO_CHAT_UPDATE_SHARE_MESSAGE';
