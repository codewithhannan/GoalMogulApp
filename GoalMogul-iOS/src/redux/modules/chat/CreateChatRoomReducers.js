...
export const CHAT_NEW_UPDATE_SELECTED_MEMBERS = 'chat_new_update_selected_members';
...
export const CHAT_NEW_REFRESH_FRIENDS_SEARCH_BEGIN = 'chat_new_refresh_friends_search_begin';
export const CHAT_NEW_LOAD_MORE_FRIENDS_SEARCH = 'chat_new_load_more_friends_search';
export const CHAT_NEW_LOAD_MORE_FRIENDS_SEARCH_BEGIN = 'chat_new_load_more_friends_search_begin';
...
export default (state = INITIAL_STATE, action) => {
  switch (action.type) {
    ...
    case CHAT_NEW_UPDATE_SELECTED_MEMBERS: {
        const newState = _.cloneDeep(state);
        return _.set(newState, 'selectedMembers', arrayUnique(action.payload));
    }
    ...
    case CHAT_NEW_LOAD_MORE_FRIENDS_SEARCH: {
      ...
      newState = _.set(newState, 'pageOffset', state.pageOffset + state.pageSize);
      ...
      return _.set(newState, `searchResults`, arrayUnique(oldResults.concat(results)));
    }
