  ...
  Alert.alert(
    ...
    [
      ...
      },
      {
        text: "Confirm",
        onPress: () =>
          doMyTribeAdminRemoveUser(userId, tribeId)(dispatch, getState),
      },
    ],
    { cancelable: false }
  );
  ...
  Alert.alert(
    ...
    [
      ...
      },
      {
        text: "Confirm",
        onPress: () =>
          doMyTribeAdminPromoteUser(userId, tribeId)(dispatch, getState),
      },
    ],
    { cancelable: false }
  );
  ...
  Alert.alert(
    ...
    [
      ...
      },
      {
        text: "Confirm",
        onPress: () =>
          doMyTribeAdminDemoteUser(userId, tribeId)(dispatch, getState),
      },
    ],
    { cancelable: false }
  );
...
const doAdminAcceptUser = (userId, tribeId) => (dispatch, getState) => {
  ...
  const onError = (err) => {
    ...
    Alert.alert("Accept member join request failed", "Please try again later");
  };
...
export const loadMoreTribeFeed = (tribeId, pageId) => (dispatch, getState) => {
  ...
  const { skip, limit, hasNextPage, feedLoading, feed, feedRefreshing } = _.get(
    tribes,
    `${tribeId}.${pageId}`
  );
