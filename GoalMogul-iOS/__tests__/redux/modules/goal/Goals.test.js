...
describe('Test specific goal update', () => {
    ...
    it("Test goal loading success for an opened page with updated goal", () => {
        const action = {
            type: GOAL_DETAIL_FETCH_DONE,
            payload: { goalId: _.get(DEFAULT_GOAL, "_id"), pageId, goal: _.set(DEFAULT_GOAL, "General", "test") }
        };
    ...
    it("Test goal mark as complete", () => {
        const action = {
            ...
            payload: { goalId: _.get(DEFAULT_GOAL, "_id"), data: { isCompleted: true } }
        };
        sharedGoalStore = Goals(sharedGoalStore, action);
        expect(sharedGoalStore).toMatchSnapshot();
    });
    ...
    it("Test goal mark a need as complete", () => {
        const action = {
            ...
            payload: { goalId: _.get(DEFAULT_GOAL, "_id"), pageId, id: _.get(DEFAULT_GOAL, "needs[0]._id"), isCompleted: true }
        };
        sharedGoalStore = Goals(sharedGoalStore, action);
        expect(sharedGoalStore).toMatchSnapshot();
    });
    ...
    it("Test goal mark a need as incomplete", () => {
        const action = {
            type: GOAL_DETAIL_MARK_NEED_AS_COMPLETE_SUCCESS,
            payload: { goalId: _.get(DEFAULT_GOAL, "_id"), pageId, id: _.get(DEFAULT_GOAL, "needs[0]._id"), isCompleted: false }
        };
        sharedGoalStore = Goals(sharedGoalStore, action);
        expect(sharedGoalStore).toMatchSnapshot();
    });
    ...
    it("Test goal mark a step as complete", () => {
        const action = {
            ...
            payload: { goalId: _.get(DEFAULT_GOAL, "_id"), pageId, id: _.get(DEFAULT_GOAL, "steps[0]._id"), isCompleted: false }
        };
        sharedGoalStore = Goals(sharedGoalStore, action);
        expect(sharedGoalStore).toMatchSnapshot();
    });
    ...
    it("Test goal like", () => {
        const action = {
            type: LIKE_GOAL,
            payload: { id: _.get(DEFAULT_GOAL, "_id"), likeId: 'like', undo: false }
        };
        sharedGoalStore = Goals(sharedGoalStore, action);
        expect(sharedGoalStore).toMatchSnapshot();
    });
    ...
    it("Test goal like undo", () => {
        const action = {
            type: LIKE_GOAL,
            payload: { id: _.get(DEFAULT_GOAL, "_id"), likeId: 'undefined', undo: true }
        };
        sharedGoalStore = Goals(sharedGoalStore, action);
        expect(sharedGoalStore).toMatchSnapshot();
    });
    ...
    it("Test goal unlike", () => {
        const action = {
            type: UNLIKE_GOAL,
            payload: { id: _.get(DEFAULT_GOAL, "_id"), likeId: 'undefined', undo: false }
        };
        sharedGoalStore = Goals(sharedGoalStore, action);
        expect(sharedGoalStore).toMatchSnapshot();
    });
    ...
    it("Test goal unlike undo", () => {
        const action = {
            type: UNLIKE_GOAL,
            payload: { id: _.get(DEFAULT_GOAL, "_id"), likeId: 'like', undo: true }
        };
        sharedGoalStore = Goals(sharedGoalStore, action);
        expect(sharedGoalStore).toMatchSnapshot();
    });
